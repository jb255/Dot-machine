...
typedef union Pad {
    enum {
        Select = 0b1111111101111111,
         ...
         Right = 0b1111111111111011, /*! Right's key \f$ ESC [ C \f$. */
          Down = 0b1111111111111101, /*! Down's key \f$ ESC [ B \f$. */
          Left = 0b1111111111111110, /*! Left's key \f$ ESC [ D \f$. */
